...
<head>
	...
	<![endif]-->
	<script src="templates/dropzone/dropzone.js"></script>
	<link rel="stylesheet" href="templates/dropzone/dropzone.css"/>
</head>
	...
	<script>
		(function($)
		{
			...
			Dropzone.options.myAwesomeDropzone = {
				paramName: "new_photo_file[]", // The name that will be used to transfer the file
				maxFilesize: 2
			      };
