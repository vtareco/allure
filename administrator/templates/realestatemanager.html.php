...
//***************   end for manage reviews   ********************
    ...
    static function showRequestBuyingHouses($option, $buy_requests, $pageNav) {
        ...
        $html = "<div class='house_manager_caption' ><img src='./components/com_realestatemanager/images/building_icon.jpg' alt ='Config' /> " . _REALESTATE_MANAGER_ADMIN_SALE_MANAGER . "</div>";
        $app = JFactory::getApplication();
        $app->JComponentTitle = $html;
        ?>
        <form action="index.php" method="post" name="adminForm" id="adminForm" >

            <table cellpadding="4" cellspacing="0" border="0" width="100%" class="adminlist list_03">
                <tr>
            ...
            <input type="hidden" name="option" value="<?php echo $option; ?>" />
            <input type="hidden" name="task" value="buy_requests" />
            <input type="hidden" name="boxchecked" value="0" />
        </form>
        <?php
    }
        ...
        <form action="index.php" method="post" name="adminForm" id="adminForm" >                    
            ...
            <table cellpadding="4" class="adminlist list_05">
                <tr>
                    ...
                    <th align = "center" class="title" width="30%" nowrap="nowrap"><?php echo _REALESTATE_MANAGER_LABEL_ADDRESS; ?></th>
...
?>     
                ...
                if ($reviews > false) /* show, if review exist */ {
                    ...
                    <table class="adminlist list_09">
                        <tr class="row0">
                            ...
                            <td width="10%" valign="top" align="center"><?php echo _REALESTATE_MANAGER_LABEL_REVIEW_TITLE; ?>:</td>
                            <td width="10%" valign="top" align="center"><?php echo _REALESTATE_MANAGER_LABEL_RENT_USER; ?>:</td>
                            <td width="65%" valign="top" align="center"><?php echo _REALESTATE_MANAGER_LABEL_REVIEW_COMMENT; ?>:</td>
                            <td width="5%" valign="top" align="center"><?php echo _REALESTATE_MANAGER_REVIEW_DATE; ?>:</td>
                            <td width="5%" valign="top" align="center"><?php echo _REALESTATE_MANAGER_LABEL_REVIEW_RATING; ?>:</td>
                        </tr>
            ...
            <table cellpadding="4" cellspacing="1" border="0" width="100%" class="adminform form_15">
                ...
                <tr>
                    <td colspan="2"><h2><?php echo _REALESTATE_MANAGER_HEADER_ADDRESS_FIELDS; ?></h2></td>
                </tr>
                <tr>
        ...
        <?php $lists['featuredmanager']['placeholder'] = '<input type="text" name="featuredmanager_placeholder" value="' . $realestatemanager_configuration['featuredmanager']['placeholder'] . '" class="inputbox" size="50" maxlength="500" title=""/>'; ?>
            ...
            <table cellpadding="4" cellspacing="0" border="0" width="100%" class="adminlist list_12">
                <tr>
                    ...
                    <th align = "center" class="title" width="45%" nowrap="nowrap"><?php echo _REALESTATE_MANAGER_LABEL_FEATURED_MANAGER_FEATURE; ?></th>
    ...
    static function editFeaturedManager($row, $lists) {
        ...
        <form action="index.php" method="post" name="adminForm"  id="adminForm" enctype="multipart/form-data">
            <table class="adminform form_36">
                <tr>
                    <th  class="house_manager_caption" align="left">
        <?php echo $row->id ? _HEADER_EDIT : _HEADER_ADD; ?> <?php echo _REALESTATE_MANAGER_LABEL_FEATURED_MANAGER_FEATURE; ?> 
                    </th>
                </tr>
            </table>
            <table class="adminform form_37" width="100%">
                ...
                <tr>
                    <td><?php echo _REALESTATE_MANAGER_LABEL_FEATURED_MANAGER_IMAGE; ?>:</td><td>
                        <input class="inputbox" type="file" name="image_link"  size="50" maxlength="250" /><br>
                        <i><?php echo _REALESTATE_MANAGER_LABEL_FEATURED_MANAGER_RECOMMENDED_IMAGE; ?></i>
                    </td>
                </tr> 
                <tr>
                    <td colspan="2">
        <?php if ($row->image_link != '') {
            ?>
                            ...
                            <img alt="photo" src="<?php echo "$mosConfig_live_site/components/com_realestatemanager/featured_ico/$row->image_link"; ?>"></img>      
        <?php } else echo "&nbsp"; ?>   
                    </td>
                </tr>
            </table>
