...
if (version_compare(JVERSION, "1.6.0", "lt")){
    class JElementMyHouseslayout extends JElement{
        var $_name = 'myhouseslayout';
        function fetchElement($name, $value, &$node, $control_name){
            $component_path = JPath::clean(JPATH_SITE. '/components/com_realestatemanager/views/my_houses/tmpl');
    ...
    class JFormFieldMyHouseslayout extends JFormField{
