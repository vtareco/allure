			...
			<div class="span9">
				<div class="row-fluid form-horizontal-desktop">
					<div class="span6">
						...
						<?php echo $this->form->renderField('kvk_middelburg'); ?>
						<?php echo $this->form->renderField('btw_number'); ?>
					</div>
					<div class="span6">
						<?php echo $this->form->renderField('monday'); ?>
						<?php echo $this->form->renderField('tuesday'); ?>
						<?php echo $this->form->renderField('wednesday'); ?>
						<?php echo $this->form->renderField('thursday'); ?>
						<?php echo $this->form->renderField('friday'); ?>
						<?php echo $this->form->renderField('saturday'); ?>
						<?php echo $this->form->renderField('sunday'); ?>
					</div>
				</div>
			</div>
			<div class="span3">
