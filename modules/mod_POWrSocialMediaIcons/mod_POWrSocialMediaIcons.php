<?php
/**
* Joomla! POWr Social Media Icons
*
* @version 2.0
* @author POWr.io
    ...
    class PowrHelper{
      ...
      public function add_powr_js(){
        ...
        //$js_url = '//s3-us-west-1.amazonaws.com/powr/powr.min.js';
		    $js_url = JURI::base()."modules/mod_POWrSocialMediaIcons/powr_joomla.js";
        $js = "(function(d){
...
//Create Helper
new PowrHelper();
echo "<div class='powr-social-media-icons' label='joomla_$module->id'></div>";
?>