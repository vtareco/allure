...
//Get list content
if(stripos( $params->get('layout'), 'realestatemanager')){
    $database = JFactory::getDBO();
    $GLOBALS['database'] = $database;
    require_once JPATH_SITE.'/modules/mod_bt_contentslider/helpers/realestatemanager.php';
    $list = RealEstateManagerHelper::getSpotligths();
}
else if(stripos( $params->get('layout'), 'inthespotlights')){
    $database = JFactory::getDBO();
    $GLOBALS['database'] = $database;
    require_once JPATH_SITE.'/modules/mod_bt_contentslider/helpers/inthespotlights.php';
    $list = RealEstateManagerHelper::getSpotligths();
}
else{
...
if( stripos( $params->get('layout'), 'realestatemanager') || stripos( $params->get('layout'), 'inthespotlights')){
    $pages = $list;    
}
else{
